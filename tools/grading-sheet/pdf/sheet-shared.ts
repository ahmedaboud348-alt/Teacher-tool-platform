...
export const SHEET_CSS = `
  ...
  .sheet-official .ar-b { font-size: 9px; font-weight: 700; color: #1A3055; }
  .sheet-official .fr { font-size: 8.5px; color: #3D5A6E; }
  .sheet-official .fr-b { font-size: 9px; font-weight: 700; color: #1A3055; }

  .sheet-banner {
    background: #1A3055; border-radius: 5px; padding: 8px 6px;
    text-align: center; margin-bottom: 0;
  }
  .sheet-banner .b-fr { font-size: 16px; font-weight: 900; color: #FFFFFF; letter-spacing: .5px; }
  .sheet-banner .b-ar { font-size: 14px; font-weight: 700; color: #F5E6C0; }
  .sheet-banner .b-sub { font-size: 8px; color: #93B8D8; margin-top: 1px; }
  ...
  .sheet-info .lbl { font-size: 9px; font-weight: 700; color: #2E6DA4; }
  ...
  table.sheet-tbl th {
    background: #1A3055; color: #FFFFFF; font-weight: 900; font-size: 9.5px;
    text-align: center; padding: 4px 2px; border: 0.75px solid #2E6DA4;
    line-height: 1.2;
  }
  table.sheet-tbl th.sub { background: #234D7A; color: #C8DDEF; font-weight: 700; font-size: 8px; }
  ...
  table.sheet-tbl tbody tr:nth-child(even) td { background: #EEF3F8; }
  ...
  .sheet-legend .dot { width: 5px; height: 5px; border-radius: 2px; background: #2E6DA4; }
  .sheet-legend .b { font-size: 8.5px; font-weight: 700; color: #1A3055; }
